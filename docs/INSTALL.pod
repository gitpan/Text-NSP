...
Text::NSP by following these simple steps:
    ...
    csh ./ALL-TESTS.sh # optional, but recommended
    cd ..
...
=head2 Orientation
 ...
 CHANGES           : a plain text version of docs/CHANGES.pod

 TODO              : a plain text version of docs/TODO.pod
...
$Id: INSTALL.pod,v 1.3 2008/03/20 18:00:46 tpederse Exp $
