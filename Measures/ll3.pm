...
sub initializeStatistic
{
    ...
    # check if ngram !=3 . ll statistic only defined for ngram = 2. 
    if ($ngram != 3)
    {
	$errorCodeNumber = 1;
	$errorMessage = "ll3 statistic is only available for trigrams!";
	return;
    }
...
xceed total number of trigrams.";
	...
	$logLikelihood += $n111 * log ( $n111 / $e111 ); 
    }
	...
	$logLikelihood += $n112 * log ( $n112 / $e112 ); 
    }
	...
	$logLikelihood += $n121 * log ( $n121 / $e121 ); 
    }
	...
	$logLikelihood += $n122 * log ( $n122 / $e122 ); 
    }
    if ( $n211 )
    {
        if ($e211 == 0)
 ...
 for cell (2,1,1)";
	...
	$logLikelihood += $n211 * log ( $n211 / $e211 );
}
	if ( $n212 )
    {
        if ($e212 == 0)
 ...
 for cell (2,1,2)";
        ...
        $logLikelihood += $n212 * log ( $n212 / $e212 );
    }
 ...
 for cell (2,2,1)";
        ...
        $logLikelihood += $n221 * log ( $n221 / $e221 );
    }
 ...
 for cell (2,2,2)";
        ...
        $logLikelihood += $n222 * log ( $n222 / $e222 );
    }
