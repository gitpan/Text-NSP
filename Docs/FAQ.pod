...
other since they both occur with "line". Then "operator" is said to be a 
third order co-occurrence of "line" since it occurs with "telephone" which 
is a second order co-occurrence of "line". 
...
Copyright (C) 2000-2004 Ted Pedersen
