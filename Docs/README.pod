...
DESCRIPTION
  ...
  6. Program statistic.pl:
   ...
   6.5. The Measures of Association Provided in This Distribution:
    ...
    file Docs/NewStats.txt. A few additional details about the Measures can
    be found in docs/Measures.pod.
...
COPYRIGHT
    Copyright (C) 2003 Ted Pedersen, Satanjeev Banerjee, and Amruta
    Purandare
