...
my $right = Text::NSP::Measures::2D::Fisher::right->new();
if($right)
{
    my $err = $right->{errorCodeNumber};
    if($err)
    {
        print "not ok 2\n";
    }
...
$value = $right->calculateStatistic(n11 => 10,
                                 n1p => 20,
                                 np1 => 20,
                                 npp => 60);
$err = $right->getErrorCode();
if($err)
{
    print "not ok 3\n";
}
...
$value = $right->calculateStatistic(%count_values);
